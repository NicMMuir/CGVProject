...
loader.load('./3DObjects/Enemy/scene.gltf', function(gltf){
    ...
    CurvyEnemiShort.push(curveEnemy8);
    ...
    CurvyEnemiShort.push(curveEnemy9);
    ...
    CurvyEnemiShort.push(curveEnemy10);
...
for (i=0; i<CurvyEnemiShort.length; i++){
   var  targetPositionZ = CurvyEnemiShort[i].position.z += 28;
  var  targetPositionNZ = CurvyEnemiShort[i].position.z += -19;
