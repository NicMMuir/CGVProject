...
, 1105.6406775065648);
  cl.push(tp);
  var tp = new THREE.Vector3(  -1601.9490591188346
, 262
, 1083.1775578075449);
  cl.push(tp);
   tp = new THREE.Vector3( -1917.9761822269172
, 262
, 1026.681909357729);
  cl.push(tp);
   tp = new THREE.Vector3( -1893.6645781405218
, 262
, 963.0151091153248);
  cl.push(tp);
   tp = new THREE.Vector3( -1992.1653980636834
, 262
, 897.3100913834802);
  cl.push(tp);
   tp = new THREE.Vector3( -1868.5638968012327
, 262
, 922.8188085099733);
  cl.push(tp);
   tp = new THREE.Vector3( -1797.4436600404672
, 262
, 898.9552055521817
);
  cl.push(tp);
   tp = new THREE.Vector3( -1798.419295530447
, 262
, 946.6519376780916);
  cl.push(tp);
   tp = new THREE.Vector3( -1789.6672655326602
, 262
, 1043.7082866803967);
  cl.push(tp);
   tp = new THREE.Vector3( -1816.223442017201
, 262
, 1103.2007991957457);
  cl.push(tp);
   tp = new THREE.Vector3( -1758.4785826303944
, 262
, 1062.1267322893457);
  cl.push(tp);
  tp = new THREE.Vector3( -1733.40765513615
, 262
, 907.8609969854831
);
  cl.push(tp);
  tp = new THREE.Vector3( -1670.2550677865584
, 262
, 955.817342713521);
  cl.push(tp);
  tp = new THREE.Vector3( -1697.739584641906
, 262
, 1039.873580716563);
  cl.push(tp);
  tp = new THREE.Vector3( -1660.2678165727077
, 262
, 1106.536055603613);
  cl.push(tp);
  tp = new THREE.Vector3( -1600.1804078525831
, 262
, 929.7022678598332);
  cl.push(tp);
  tp = new THREE.Vector3( -1541.1294924298868
, 262
, 993.3143059681476);
  cl.push(tp);
  tp = new THREE.Vector3( -1499.403898720993
, 262
, 1107.2460592277648);
  cl.push(tp);
  tp = new THREE.Vector3( -1465.3989863844404
, 262
, 1024.0410270710317);
  cl.push(tp);
  tp = new THREE.Vector3( -1493.5135407517764
, 262
, 895.9986411293559);
  cl.push(tp);
  tp = new THREE.Vector3( -1393.5023836569064
, 262
, 1020.2202362836753);
  cl.push(tp);
  tp = new THREE.Vector3( -1371.5410066586967
, 262
, 1070.3239236157633);
  cl.push(tp);
  tp = new THREE.Vector3( -1339.4945606114454
, 262
, 1104.5673395089918);
  cl.push(tp);
  tp = new THREE.Vector3( -1329.3554933496455
, 262
, 959.6607290362774);
  cl.push(tp);
  tp = new THREE.Vector3( -1347.8901462194624
, 262
, 919.4351196244829);
  cl.push(tp);
  tp = new THREE.Vector3( -1287.6710935850663
, 262
, 892.1221437922044);
  cl.push(tp);
  tp = new THREE.Vector3( -1249.4363802761738
, 262
, 938.4700411725482);
  cl.push(tp);
  tp = new THREE.Vector3( -1263.7829047715813
, 262
, 983.3980201457753);
  cl.push(tp);
  tp = new THREE.Vector3( -1234.036588236264
, 262
, 1050.2176331078613);
  cl.push(tp);
  tp = new THREE.Vector3( -1203.898933885937
, 262
, 1108.0731242214797);
  cl.push(tp);
  tp = new THREE.Vector3( -1189.7695879660716
, 262
, 1056.9483464319696
);
  cl.push(tp);
  tp = new THREE.Vector3( -1206.048682674541
, 262
, 957.6077856906622);
  cl.push(tp);
  tp = new THREE.Vector3( -1191.2676196488212
, 262
, 919.9903855772332);
  cl.push(tp);
  tp = new THREE.Vector3( -1160.7772498352106
, 262
, 946.2403341263139);
  cl.push(tp);
  tp = new THREE.Vector3( -1162.0375196979246
, 262
, 985.0292167004601);
  cl.push(tp);
  tp = new THREE.Vector3( -1163.6827225027964
, 262
, 1037.8100800310829);
  cl.push(tp);
  tp = new THREE.Vector3( -1134.0496580062822
, 262
, 1107.4937078146838);
  cl.push(tp);
  tp = new THREE.Vector3( -1078.5167496293118
, 262
, 1069.6832567820802
);
  cl.push(tp);
  tp = new THREE.Vector3( -1099.1265455663208
, 262
, 1022.2640801109702);
  cl.push(tp);
  tp = new THREE.Vector3( -1090.6143824546737
, 262
, 963.0034035400172);
  cl.push(tp);
  tp = new THREE.Vector3( -1111.4376432105405
, 262
, 891.7843364720532);
  cl.push(tp);
  tp = new THREE.Vector3( -1029.2917823362466
, 262
, 908.9657241691748);
  cl.push(tp);
  tp = new THREE.Vector3( -1002.5899216570683
, 262
, 939.8397383798758
);
  cl.push(tp);
  tp = new THREE.Vector3( -1012.1785391905026
, 262
, 986.9615214612513);
  cl.push(tp);
  tp = new THREE.Vector3( -1003.2787255424622
, 262
, 1085.3948701075064);
  cl.push(tp);

  //Second floor coin coordinates (still Map 3)
  tp = new THREE.Vector3( -634.7757132410078
, 213
, 1094.8066867176858);
  cl.push(tp);
  tp = new THREE.Vector3( -608.2642029487492
, 213
, 1048.4957950430796);
  cl.push(tp);
  tp = new THREE.Vector3( -620.3174528802336
, 213
, 999.0686370653245);
  cl.push(tp);
  tp = new THREE.Vector3( -615.1413016643726
, 213
, 898.994156107781);
  cl.push(tp);
  tp = new THREE.Vector3( -582.7347257370513
, 213
, 968.8086806382425);
  cl.push(tp);
  tp = new THREE.Vector3( -575.4985947740415
, 213
, 1027.3438492229807);
  cl.push(tp);
  tp = new THREE.Vector3( -555.6019114073802
, 213
, 1082.4718081672056);
  cl.push(tp);
  tp = new THREE.Vector3( -501.80369936122923
, 213
, 1101.8761698187927);
  cl.push(tp);
  tp = new THREE.Vector3( -500.6874935550783
, 213
, 1043.5022955927775);
  cl.push(tp);
  tp = new THREE.Vector3( -498.2356923291507
, 213
, 963.6557142138711);
  cl.push(tp);
  tp = new THREE.Vector3( -502.9519459646106
, 213
, 884.5855362921542);
  cl.push(tp);
  tp = new THREE.Vector3( -460.57554346323974
, 213
, 922.7159336656072);
  cl.push(tp);
  tp = new THREE.Vector3( -458.4459446942816
, 213
, 980.8050235811883);
  cl.push(tp);
  tp = new THREE.Vector3( -461.1436662413908
, 213
, 1063.3321647534165);
  cl.push(tp);
  tp = new THREE.Vector3( -404.0473905055189
, 213
, 1118.1545891780174);
  cl.push(tp);
  tp = new THREE.Vector3( -382.9331369587713
, 213
, 1041.7233072483275);
  cl.push(tp);
  tp = new THREE.Vector3( -380.7235106603617
, 213
, 959.8049501165217);
  cl.push(tp);
  tp = new THREE.Vector3( -420.73907904324926
, 213
, 923.8451669102643);
  cl.push(tp);
  tp = new THREE.Vector3( -356.0024421274597
, 213
, 883.7297018465982);
  cl.push(tp);
  tp = new THREE.Vector3( -331.63596514666267
, 213
, 949.1676607996511);
  cl.push(tp);
  tp = new THREE.Vector3( -337.864185999635
, 213
, 1020.7858882293423);
  cl.push(tp);
  tp = new THREE.Vector3( -338.5606407149892
, 213
, 1102.6098152938937);
  cl.push(tp);
  tp = new THREE.Vector3( -282.5364403446339
, 213
, 1086.8675641230561);
  cl.push(tp);
  tp = new THREE.Vector3( -258.3086508596726
, 213
, 1023.0989646105099
);
  cl.push(tp);
  tp = new THREE.Vector3( -298.26784283639654
, 213
, 882.446556551861);
  cl.push(tp);
  tp = new THREE.Vector3( -222.72197438884996
, 213
, 882.1591982997062);
  cl.push(tp);
  tp = new THREE.Vector3( -221.77579861975704
, 213
, 966.4185353419339);
  cl.push(tp);
  tp = new THREE.Vector3( -204.91445116002114
, 213
, 1026.6832535244846);
  cl.push(tp);
  tp = new THREE.Vector3( -183.33920089649575
, 213
, 1082.3032449459638);
  cl.push(tp);
  tp = new THREE.Vector3( -142.05462960070537
, 213
, 1042.0431014732235);
  cl.push(tp);
  tp = new THREE.Vector3( -142.5581065122914
, 213
, 962.7864417020958);
  cl.push(tp);

  //Bridge + Final floor(Ring) coin coordinates (still Map 3)
  tp = new THREE.Vector3( -320.8436525979217
, 213
, 720.970862028136);
  cl.push(tp);
  tp = new THREE.Vector3( -283.0508648267947
, 213
, 635.703402520972);
  cl.push(tp);
  tp = new THREE.Vector3( -297.6890614700544
, 213
, 567.0638237498969);
  cl.push(tp);
  tp = new THREE.Vector3( -275.9485079219138
, 213
, 513.5017596834496);
  cl.push(tp);
  tp = new THREE.Vector3( -313.41723988148715
, 213
, 469.0562440809303);
  cl.push(tp);
  tp = new THREE.Vector3( -300.8762273524697
, 213
, 398.36402438028466);
  cl.push(tp);
  tp = new THREE.Vector3( -276.7685893714112
, 213
, 304.077584311553);
  cl.push(tp);
  tp = new THREE.Vector3( -314.7009828206713
, 213
, 227.70998965936272);
  cl.push(tp);
  tp = new THREE.Vector3( -268.9248080007499
, 213
, 139.1112928706916);
  cl.push(tp);
  tp = new THREE.Vector3( -329.0773347252905
, 213
, 32.81094263747358);
  cl.push(tp);
  tp = new THREE.Vector3( -301.7607762188956
, 213
, -54.043143175004694);
  cl.push(tp);
  tp = new THREE.Vector3( -216.3588557512089
, 213
, -133.54424728042846);
  cl.push(tp);
  tp = new THREE.Vector3( -104.90951381599096
, 213
, -166.03175565756032);
  cl.push(tp);
  tp = new THREE.Vector3( -58.191280294751216
, 213
, -229.906685344212
);
  cl.push(tp);
  tp = new THREE.Vector3( -11.311663226495567
, 213
, -262.71924632982666);
  cl.push(tp);
  tp = new THREE.Vector3( 74.6469406358824
, 213
, -385.9803132031371);
  cl.push(tp);
  tp = new THREE.Vector3( 73.30057817351229
, 213
, -486.4042929988403);
  cl.push(tp);
  tp = new THREE.Vector3( 69.97230864195609
, 213
, -665.507194162306);
  cl.push(tp);
  tp = new THREE.Vector3( -2.0674280375813314
, 213
, -776.1305050123518);
  cl.push(tp);
  tp = new THREE.Vector3( -118.70790721135144
, 213
, -879.8932429283684);
  cl.push(tp);
  tp = new THREE.Vector3( -229.31991205140423
, 213
, -903.9447799236608);
  cl.push(tp);
  tp = new THREE.Vector3( -390.54091428295663
, 213
, -145.60389405437488);
  cl.push(tp);
  tp = new THREE.Vector3( -529.4908456645553
, 213
, -209.84294501250824);
  cl.push(tp);
  tp = new THREE.Vector3( -662.4496332165584
, 213
, -332.6310711309307);
  cl.push(tp);
  tp = new THREE.Vector3( -700.1461354196516
, 213
, -491.5055300467934);
  cl.push(tp);
  tp = new THREE.Vector3( -665.5224280003166
, 213
, -567.3234402122403);
  cl.push(tp);
  tp = new THREE.Vector3( -627.8128813645944
, 213
, -732.2427908997184);
  cl.push(tp);
  tp = new THREE.Vector3( -441.390977199012
, 213
, -875.751098277553);
  cl.push(tp);
